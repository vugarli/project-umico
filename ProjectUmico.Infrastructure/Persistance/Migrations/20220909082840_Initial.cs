    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductInPromotionsId = table.Column<int>(type: "int", nullable: false),
                    ProductsInPromotionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPromotion", x => new { x.ProductInPromotionsId, x.ProductsInPromotionId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductPromotion_Promotion_ProductInPromotionsId",
                        column: x => x.ProductInPromotionsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPromotion_ProductsInPromotionId",
                table: "ProductPromotion",
                column: "ProductsInPromotionId");
